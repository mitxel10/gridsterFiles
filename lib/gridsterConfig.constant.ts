...
export const GridsterConfigService: GridsterConfig = {
  ...
  minWidthToAddANewColumn: 310, // minimum width within gridster to add a new column when dynamicColumns is true. The predefined margin in between columns and outerMargin (if true) are added to this number in the calculation.
